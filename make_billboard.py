...
def make_billboard(text, objFlag=False, objName=""):
  ...
  if not objFlag:
    ...
    fobj.write("usemtl " + mtl_name + "\n")

    fobj.write("f 1/1 2/2 3/3\n")
    fobj.write("f 1/1 3/3 4/4\n")
    fobj.close()

    mtllib.make_mtllib(mtl_file, mtl_name, texture_name)
